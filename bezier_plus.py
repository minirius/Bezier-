...
class App:
    ...
    def draw_points(self):
        for i, p in enumerate(self.POINTS):
            ...
            self.canvas.create_text((x+10, y+10), text="P"+str(i), fill="black", font='tkDefaeultFont 12')
    ...
    def open_file(self):
        ...
        for i, e in enumerate(root[1][0].iter()):
            if(e.attrib != {}):
                ...
                x2, y2 = (x + (8/2)), (y + (8/2))
                self.canvas.create_oval(x1, y1, x2, y2, fill="black")
                self.canvas.create_text((x+10, y+10), text="P"+str(i-1), fill="black", font='tkDefaeultFont 12')
    ...
    def place_point(self, event):
        if(self.isHovering): self.start_moving = True; return
            ...
            self.canvas.create_oval(x1, y1, x2, y2, fill="black")
            self.canvas.create_text((event.x+10, event.y+10), text="P"+str(len(self.POINTS)), fill="black", font='tkDefaeultFont 12')
